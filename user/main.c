...
int main(void)
{
  ...
  thread[1] = rt_thread_create("W25QXX",
                               W25QXX_task,
                               RT_NULL,
  ...
  thread[2] = rt_thread_create("UART",
                               UART_task,
                               RT_NULL,
  ...
  thread[3] = rt_thread_create("SDIO",
                               SDIO_task,
                               RT_NULL,
  ...
  thread[6] = rt_thread_create("WDOG",
                               WDOG_task,
                               RT_NULL,
